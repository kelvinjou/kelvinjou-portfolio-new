        ...
        {currentTabs === "RESUME" && (
          <div className="mt-10">
            ...
            <div className="mt-10">
              ...
              <hr className="my-10"></hr>
              <div className="flex">
                <label className="w-1/5 text-lg opacity-50">Cloud</label>
                <div className="w-4/5 ml-10 flex flex-col">
                  {data.resume.cloud.map((other, index) => (
                    <div key={index} className="flex">
                      <input
                        value={other}
                        onChange={(e) => {
                          setData({
                            ...
                            resume: {
                              ...data.resume,
                              others: [
                                ...data.resume.cloud.slice(0, index),
                                e.target.value,
                                ...data.resume.cloud.slice(index + 1),
                              ],
                            },
                          });
                        }}
                      ...
                      <Button
                        onClick={() =>
                          setData({
                            ...
                            resume: {
                              ...data.resume,
                              others: data.resume.cloud.filter(
                                (value, i) => index !== i
                              ),
                            },
                          })
                  ...
                  <Button
                    onClick={() =>
                      setData({
                        ...
                        resume: {
                          ...data.resume,
                          others: [...data.resume.cloud, "Added"],
                        },
                      })
                    }
                    type="primary"
